...
export default function AffiliateLogin({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col justify-center px-5">
      <h1 className="font-display text-2xl font-bold">Espace affilié</h1>
      <p className="mt-1 text-sm opacity-60">
        Connecte-toi avec les identifiants qui t&apos;ont été transmis.
      </p>
